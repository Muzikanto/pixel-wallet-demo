import { a as C, R as Do, t as H, p as K, T as N, n as _t, s as ce, y as gt, o as ot } from "./index-hF-FWp88.js";
import "./index-BELpSH6A.js"; /**
 * @license
...
const ro = class {
  ...
  get styleSheet() {
    ...
    if (pr && t === void 0) {
      ...
      n && (t = Ar.get(r)),
        t === void 0 && ((this.o = t = new CSSStyleSheet()).replaceSync(this.cssText), n && Ar.set(r, t));
    }
    return t;
  }
  toString() {
...
const Uo = (e) => new ro(typeof e == "string" ? e : e + "", void 0, wr),
  T = (e, ...t) => {
    const r =
      e.length === 1
        ? e[0]
...
const he = window,
  ...
  oo = (e, t) => t !== e && (t == t || e == e),
  Ee = { attribute: !0, type: String, converter: ar, reflect: !1, hasChanged: oo },
  sr = "finalized";
const $t = class extends HTMLElement {
  ...
  createRenderRoot() {
    var t;
    const r =
      (t = this.shadowRoot) !== null && t !== void 0 ? t : this.attachShadow(this.constructor.shadowRootOptions);
  ...
  _$EO(t, r, n = Ee) {
    ...
    if (i !== void 0 && n.reflect === !0) {
      const a = (
        ((o = n.converter) === null || o === void 0 ? void 0 : o.toAttribute) !== void 0 ? n.converter : ar
      ...
      const a = o.getPropertyOptions(i),
        s =
          typeof a.converter == "function"
            ...
            : ((n = a.converter) === null || n === void 0 ? void 0 : n.fromAttribute) !== void 0
              ? a.converter
              : ar;
  ...
  requestUpdate(t, r, n) {
    let o = !0;
    t !== void 0 &&
      (((n = n || this.constructor.getPropertyOptions(t)).hasChanged || oo)(this[t], r)
        ? (this._$AL.has(t) || this._$AL.set(t, r),
          n.reflect === !0 && this._$El !== t && (this._$EC === void 0 && (this._$EC = new Map()), this._$EC.set(t, n)))
        : (o = !1)),
...
($t[sr] = !0),
  ...
  kr == null || kr({ ReactiveElement: $t }),
  ((Ce = he.reactiveElementVersions) !== null && Ce !== void 0 ? Ce : (he.reactiveElementVersions = [])).push(
    "1.6.3",
  ); /**
 * @license
 * Copyright 2017 Google LLC
...
const ue = window,
  It = ue.trustedTypes,
  Tr = It ? It.createPolicy("lit-html", { createHTML: (e) => e }) : void 0,
  lr = "$lit$",
  ...
  io = Array.isArray,
  zo = (e) => io(e) || typeof (e == null ? void 0 : e[Symbol.iterator]) == "function",
  _e = `[ 	
\f\r]`,
...
const Fo = (e, t) => {
  ...
  for (let s = 0; s < r; s++) {
    ...
    let c,
      ...
      b = -1,
      h = 0;
    while (h < l.length && ((a.lastIndex = h), (d = a.exec(l)), d !== null))
      (h = a.lastIndex),
        a === Pt
          ? d[1] === "!--"
            ? (a = Mr)
            : d[1] !== void 0
              ? (a = Sr)
              : d[2] !== void 0
                ? (ao.test(d[2]) && (o = RegExp("</" + d[2], "g")), (a = lt))
                : d[3] !== void 0 && (a = lt)
          : a === lt
            ? d[0] === ">"
              ? ((a = o ?? Pt), (b = -1))
              : d[1] === void 0
                ? (b = -2)
                : ((b = a.lastIndex - d[2].length), (c = d[1]), (a = d[3] === void 0 ? lt : d[3] === '"' ? Rr : Or))
            : a === Rr || a === Or
              ? (a = lt)
              : a === Mr || a === Sr
                ? (a = Pt)
    ...
    i +=
      a === Pt
        ...
        : b >= 0
          ...
          : l + rt + (b === -2 ? (n.push(void 0), s) : f);
  }
  return [lo(e, i + (e[r] || "<?>") + (t === 2 ? "</svg>" : "")), n];
};
class Kt {
  constructor({ strings: t, _$litType$: r }, n) {
    ...
    while ((o = ut.nextNode()) !== null && l.length < s) {
      if (o.nodeType === 1) {
        if (o.hasAttributes()) {
          const b = [];
        ...
        if (o.data === no) l.push({ type: 2, index: i });
        else {
          let b = -1;
          while ((b = o.data.indexOf(rt, b + 1)) !== -1) l.push({ type: 7, index: i }), (b += rt.length - 1);
        }
      i++;
    }
  }
...
function kt(e, t, r = e, n) {
  ...
  return (
    (l == null ? void 0 : l.constructor) !== c &&
      ...
      n !== void 0 ? (((a = (s = r)._$Co) !== null && a !== void 0 ? a : (s._$Co = []))[n] = l) : (r._$Cl = l)),
  ...
  g(t) {
    ...
    const { values: n, _$litType$: o } = t,
      i =
        typeof o == "number"
          ? this._$AC(t)
          : (o.el === void 0 && (o.el = Kt.createElement(lo(o.h, o.h[0]), this.options)), o);
...
(A.finalized = !0),
  (A._$litElement$ = !0),
  (Ie = globalThis.litElementHydrateSupport) === null || Ie === void 0 || Ie.call(globalThis, { LitElement: A });
...
const co = (e, t, r) => Math.min(Math.max(r, e), t),
  Z = { duration: 0.3, delay: 0, endDelay: 0, repeat: 0, easing: "ease" },
...
function ln(e, t = sn(e.length), r = it) {
  ...
  return (
    ...
    (i) => {
      let a = 0;
      for (; a < n - 2 && !(i < t[a + 1]); a++);
      let s = co(0, 1, vr(t[a], t[a + 1], i));
      return (s = an(r, a)(s)), ho(e[a], e[a + 1], s);
    }
  );
}
const go = (e) => Array.isArray(e) && me(e[0]),
  cr = (e) => typeof e == "object" && !!e.createAnimation,
  Tt = (e) => typeof e == "function",
  cn = (e) => typeof e == "string",
  zt = { ms: (e) => e * 1e3, s: (e) => e / 1e3 },
  fo = (e, t, r) => (((1 - 3 * r + 3 * t) * e + (3 * r - 6 * t)) * e + 3 * t) * e,
  dn = 1e-7,
  hn = 12;
function un(e, t, r, n, o) {
  let i,
    a,
    s = 0;
  do (a = t + (r - t) / 2), (i = fo(a, n, o) - e), i > 0 ? (r = a) : (t = a);
...
function Br(e) {
  ...
  if (e.startsWith("steps")) {
    ...
    if (r) {
      const n = r[1].split(",");
      return mn(Number.parseFloat(n[0]), n[1].trim());
    }
  }
  return it;
}
class po {
  constructor(
    ...
    (this.repeat = s), (this.easing = Et(n) ? it : Br(n)), this.updateDuration(o);
    const b = ln(r, l, Et(n) ? n.map(Br) : it);
    (this.tick = (h) => {
      var f;
      i = i;
      let p = 0;
      ...
      const w = p >= this.totalDuration ? 1 : Math.min(u, 1),
        v = b(this.easing(w));
      t(v),
        this.pauseTime === void 0 && (this.playState === "finished" || p >= this.totalDuration + a)
...
function wo(e) {
  return Me.has(e) || Me.set(e, { transforms: [], values: new Map() }), Me.get(e);
}
function wn(e, t) {
...
const vn = ["", "X", "Y", "Z"],
  ...
  Dr = { syntax: "<angle>", initialValue: "0deg", toDefaultUnit: (e) => e + "deg" },
  yn = {
...
bn.forEach((e) => {
  vn.forEach((t) => {
    fe.push(e + t), qt.set(br(e + t), yn[e]);
  });
});
const xn = (e, t) => fe.indexOf(e) - fe.indexOf(t),
  $n = new Set(fe),
  vo = (e) => $n.has(e),
  Cn = (e, t) => {
    ge[t] && (t = ge[t]);
    const { transforms: r } = wo(e);
    on(r, t), (e.style.transform = En(r));
  },
  En = (e) => e.sort(xn).reduce(An, "").trim(),
  An = (e, t) => `${e} ${t}(var(${br(t)}))`,
  dr = (e) => e.startsWith("--"),
  Ur = new Set();
function _n(e) {
...
const Se = (e, t) => document.createElement("div").animate(e, t),
  ...
  Oe = {},
  Ct = {};
for (const e in Wr) Ct[e] = () => (Oe[e] === void 0 && (Oe[e] = Wr[e]()), Oe[e]);
const In = 0.015,
  kn = (e, t) => {
    let r = "";
  ...
  Hr = (e, t) => (Tt(e) ? (Ct.linearEasing() ? `linear(${kn(e, t)})` : Z.easing) : go(e) ? Tn(e) : e),
...
function hr(e) {
  return ge[e] && (e = ge[e]), vo(e) ? br(e) : e;
}
const Xt = {
  get: (e, t) => {
    t = hr(t);
...
function Pn(e, t, r, n = {}, o) {
  ...
  const E = hr(t),
    ...
    R = qt.get(E);
  return (
    bo(O.animation, !(cr(h) && O.generator) && n.record !== !1),
    () => {
      const U = () => {
        var P, Y;
        return (Y = (P = Xt.get(e, E)) !== null && P !== void 0 ? P : R == null ? void 0 : R.initialValue) !== null &&
          Y !== void 0
          ? Y
          : 0;
      };
      ...
      if (
        (dr(E) && (Ct.cssRegisterProperty() ? _n(E) : (v = !1)),
        w && !Ct.linearEasing() && (Tt(h) || (Et(h) && h.some(Tt))) && (v = !1),
        v)
      ) {
        R && (S = S.map((D) => (me(D) ? R.toDefaultUnit(D) : D))),
          S.length === 1 && (!Ct.partialKeyframes() || a) && S.unshift(U());
        const P = {
          delay: zt.ms(c),
          duration: zt.ms(l),
          endDelay: zt.ms(d),
        ...
        (s = e.animate({ [E]: S, offset: g, easing: Et(h) ? h.map((D) => Hr(D, l)) : void 0 }, P)),
          s.finished ||
            (s.finished = new Promise((D, Bo) => {
        ...
        s.finished
          ...
          .catch(uo),
          _ || (s.playbackRate = 1.000001);
      } else if (o && w)
        (S = S.map((P) => (typeof P == "string" ? Number.parseFloat(P) : P))),
          S.length === 1 && S.unshift(Number.parseFloat(U())),
          (s = new o(
            (P) => {
              Xt.set(e, E, z ? z(P) : P);
            },
      ...
      return (
        a && i(e, t, S, { duration: l, delay: c, easing: h, repeat: b, offset: g }, "motion-one"),
        O.setAnimation(s),
        s && !u && s.pause(),
        s
      );
...
function Nn(e, t) {
  return (
    typeof e == "string" ? (e = document.querySelectorAll(e)) : e instanceof Element && (e = [e]), Array.from(e || [])
  );
}
const Bn = (e) => e(),
  yo = (e, t, r = Z.duration) => new Proxy({ animations: e.map(Bn).filter(Boolean), duration: r, options: t }, Un),
  Dn = (e) => e.animations[0],
  Un = {
    get: (e, t) => {
      const r = Dn(e);
      switch (t) {
        ...
        case "finished":
          return e.finished || (e.finished = Promise.all(e.animations.map(Wn)).catch(uo)), e.finished;
        case "stop":
          return () => {
            e.animations.forEach((n) => bo(n));
          };
        case "forEachNative":
          return (n) => {
...
function jn(e) {
  return (r, n, o = {}) => {
    ...
    for (let s = 0; s < i; s++) {
      ...
      for (const c in n) {
        const d = Ln(o, c);
        d.delay = Hn(d.delay, s, i);
        const b = Pn(l, c, n[c], d, e);
        a.push(b);
      }
    }
    return yo(a, o, o.duration);
  };
}
const zn = jn(po);
function Fn(e, t = {}) {
...
const W = (e) => e ?? B;
var Gt = {},
  Zn = () => typeof Promise == "function" && Promise.prototype && Promise.prototype.then,
  xo = {},
  F = {};
let yr;
const Vn = [
  0, 26, 44, 70, 100, 134, 172, 196, 242, 292, 346, 404, 466, 532, 581, 655, 733, 815, 901, 991, 1085, 1156, 1258, 1364,
...
F.getSymbolTotalCodewords = (t) => Vn[t];
F.getBCHDigit = (e) => {
  let t = 0;
  while (e !== 0) t++, (e >>>= 1);
  return t;
};
F.setToSJISFunction = (t) => {
  if (typeof t != "function") throw new Error('"toSJISFunc" is not a valid function.');
  yr = t;
};
F.isKanjiModeEnabled = () => typeof yr < "u";
F.toSJIS = (t) => yr(t);
var be = {};
((e) => {
  ...
  (e.isValid = (n) => n && typeof n.bit < "u" && n.bit >= 0 && n.bit < 4),
    (e.from = (n, o) => {
...
((e) => {
  ...
  (e.getRowColCoords = (n) => {
    ...
    (e.getPositions = (n) => {
      ...
      for (let s = 0; s < a; s++)
        for (let l = 0; l < a; l++)
          (s === 0 && l === 0) || (s === 0 && l === a - 1) || (s === a - 1 && l === 0) || o.push([i[s], i[l]]);
      return o;
    });
})(Co);
var Eo = {};
...
((e) => {
  ...
  (e.isValid = (o) => o != null && o !== "" && !isNaN(o) && o >= 0 && o <= 7),
    (e.from = (o) => (e.isValid(o) ? Number.parseInt(o, 10) : void 0)),
    (e.getPenaltyN1 = (o) => {
      const i = o.size;
      let a = 0,
        s = 0,
      ...
      for (let b = 0; b < i; b++) {
        ...
        for (let h = 0; h < i; h++) {
          let f = o.get(b, h);
          f === c ? s++ : (s >= 5 && (a += t.N1 + (s - 5)), (c = f), (s = 1)),
            (f = o.get(h, b)),
            f === d ? l++ : (l >= 5 && (a += t.N1 + (l - 5)), (d = f), (l = 1));
        }
  ...
  (e.applyMask = (o, i) => {
    const a = i.size;
    for (let s = 0; s < a; s++) for (let l = 0; l < a; l++) i.isReserved(l, s) || i.xor(l, s, r(o, l, s));
  }),
    (e.getBestMask = (o, i) => {
...
xe.exp = (t) => Ft[t];
xe.mul = (t, r) => (t === 0 || r === 0 ? 0 : Ft[pe[t] + pe[r]]);
((e) => {
  const t = xe;
  (e.mul = (n, o) => {
    const i = new Uint8Array(n.length + o.length - 1);
    for (let a = 0; a < n.length; a++) for (let s = 0; s < o.length; s++) i[a + s] ^= t.mul(n[a], o[s]);
    return i;
  }),
    (e.mod = (n, o) => {
      let i = new Uint8Array(n);
      while (i.length - o.length >= 0) {
        const a = i[0];
        for (let l = 0; l < o.length; l++) i[l] ^= t.mul(o[l], a);
        let s = 0;
        while (s < i.length && i[s] === 0) s++;
        i = i.slice(s);
      }
      return i;
    }),
    (e.generateECPolynomial = (n) => {
...
q.BYTE_KANJI = /[^A-Z0-9 $%*+\-.\/:]+/g;
q.BYTE = new RegExp(Qn, "g");
q.NUMERIC = new RegExp(To, "g");
q.ALPHANUMERIC = new RegExp(Gn, "g");
const Xn = new RegExp("^" + Yt + "$"),
  ti = new RegExp("^" + To + "$"),
  ei = /^[A-Z0-9 $%*+\-.\/:]+$/;
q.testKanji = (t) => Xn.test(t);
q.testNumeric = (t) => ti.test(t);
q.testAlphanumeric = (t) => ei.test(t);
((e) => {
  const t = $r,
    r = q;
  (e.NUMERIC = { id: "Numeric", bit: 1, ccBits: [10, 12, 14] }),
    ...
    (e.getBestModeForData = (i) =>
      r.testNumeric(i) ? e.NUMERIC : r.testAlphanumeric(i) ? e.ALPHANUMERIC : r.testKanji(i) ? e.KANJI : e.BYTE),
    (e.toString = (i) => {
      if (i && i.id) return i.id;
      throw new Error("Invalid mode");
    }),
    (e.isValid = (i) => i && i.bit && i.ccBits);
  function n(o) {
...
((e) => {
  ...
  (e.from = (f, p) => (i.isValid(f) ? Number.parseInt(f, 10) : p)),
    (e.getCapacity = (f, p, g) => {
    ...
    (e.getEncodedBits = (f) => {
      ...
      let p = f << 12;
      while (t.getBCHDigit(p) - s >= 0) p ^= a << (t.getBCHDigit(p) - s);
      return (f << 12) | p;
    });
})(ko);
var Mo = {};
...
Mo.getEncodedBits = (t, r) => {
  const n = (t.bit << 3) | r;
  let o = n << 10;
  while (ur.getBCHDigit(o) - zr >= 0) o ^= So << (ur.getBCHDigit(o) - zr);
  return ((n << 10) | o) ^ ri;
};
var Oo = {};
const oi = st;
...
Mt.getBitsLength = (t) => 10 * Math.floor(t / 3) + (t % 3 ? (t % 3) * 3 + 1 : 0);
...
Mt.prototype.write = function (t) {
  ...
  for (r = 0; r + 3 <= this.data.length; r += 3)
    (n = this.data.substr(r, 3)), (o = Number.parseInt(n, 10)), t.put(o, 10);
  const i = this.data.length - r;
  i > 0 && ((n = this.data.substr(r)), (o = Number.parseInt(n, 10)), t.put(o, i * 3 + 1));
};
var ni = Mt;
const ii = st,
  Re = [
...
St.getBitsLength = (t) => 11 * Math.floor(t / 2) + 6 * (t % 2);
...
((e) => {
  var t = {
    single_source_shortest_paths: (r, n, o) => {
      var i = {},
        a = {};
      a[n] = 0;
      var s = t.PriorityQueue.make();
      s.push(n, 0);
      for (var l, c, d, b, h, f, p, g, _; !s.empty(); ) {
        (l = s.pop()), (c = l.value), (b = l.cost), (h = r[c] || {});
        for (d in h)
          h.hasOwnProperty(d) &&
            ((f = h[d]),
            (p = b + f),
    ...
    extract_shortest_path_from_predecessor_list: (r, n) => {
    ...
    PriorityQueue: {
      ...
      default_sorter: (r, n) => r.cost - n.cost,
      push: function (r, n) {
...
((e) => {
  ...
  function d(u, y, w) {
    const v = [];
    let E;
    while ((E = u.exec(w)) !== null) v.push({ data: E[0], index: E.index, mode: y, length: E[0].length });
    return v;
  }
  function b(u) {
    const y = d(a.NUMERIC, t.NUMERIC, u),
      w = d(a.ALPHANUMERIC, t.ALPHANUMERIC, u);
    let v, E;
    return (
      s.isKanjiModeEnabled()
        ? ((v = d(a.BYTE, t.BYTE, u)), (E = d(a.KANJI, t.KANJI, u)))
        : ((v = d(a.BYTE_KANJI, t.BYTE, u)), (E = [])),
      y
        .concat(w, v, E)
        .sort((R, U) => R.index - U.index)
        .map((R) => ({ data: R.data, mode: R.mode, length: R.length }))
    );
  }
  function h(u, y) {
    switch (y) {
      ...
      for (let S = 0; S < R.length; S++) {
        ...
        for (let Y = 0; Y < E.length; Y++) {
          ...
          w[D] && w[D].node.mode === z.mode
            ? ((v[D][P] = h(w[D].lastCount + z.length, z.mode) - h(w[D].lastCount, z.mode)),
              (w[D].lastCount += z.length))
            : (w[D] && (w[D].lastCount = z.length),
              (v[D][P] = h(z.length, z.mode) + 4 + t.getCharCountIndicator(z.mode, y)));
        }
      }
      E = U;
    }
    for (let O = 0; O < E.length; O++) v[E[O]].end = 0;
 ...
 Suggested mode is: ` +
  ...
  (e.fromArray = (y) =>
    y.reduce((w, v) => (typeof v == "string" ? w.push(_(v, null)) : v.data && w.push(_(v.data, v.mode)), w), [])),
    (e.fromString = (y, w) => {
      const v = b(y, s.isKanjiModeEnabled()),
        E = p(v),
        O = g(E, w),
        R = l.find_path(O.map, "start", "end"),
        U = [];
      for (let S = 1; S < R.length - 1; S++) U.push(O.table[R[S]].node);
      return e.fromArray(f(U));
    }),
    (e.rawSplit = (y) => e.fromArray(b(y, s.isKanjiModeEnabled())));
})(Oo);
const $e = F,
  Pe = be,
  fi = Kn,
...
function Ne(e, t, r) {
  ...
  for (i = 0; i < 15; i++)
    (a = ((o >> i) & 1) === 1),
      i < 6 ? e.set(i, 8, a, !0) : i < 8 ? e.set(i + 1, 8, a, !0) : e.set(n - 15 + i, 8, a, !0),
...
function ki(e, t, r) {
  ...
  for (let R = 0; R < a; R++) {
    const U = R < l ? d : b;
    (g[R] = y.slice(p, p + U)), (_[R] = f.encode(g[R])), (p += U), (u = Math.max(u, U));
  }
  const w = new Uint8Array(n);
  let v = 0,
    E,
    O;
  for (E = 0; E < u; E++) for (O = 0; O < a; O++) E < g[O].length && (w[v++] = g[O][E]);
  for (E = 0; E < h; E++) for (O = 0; O < a; O++) w[v++] = _[O][E];
  return w;
}
function Ti(e, t, r, n) {
  let o;
...
((e) => {
  function t(r) {
    ...
    const o = Number.parseInt(n.join(""), 16);
  ...
  (e.getOptions = (n) => {
    ...
    (e.getScale = (n, o) => (o.width && o.width >= n + o.margin * 2 ? o.width / (n + o.margin * 2) : o.scale)),
    (e.getImageWidth = (n, o) => {
      const i = e.getScale(n, o);
      return Math.floor((n + o.margin * 2) * i);
    }),
    (e.qrToImageData = (n, o, i) => {
...
function Si(e, t, r) {
  ...
  for (let s = 0; s < e.length; s++) {
    ...
    !l && !i && (i = !0),
      e[s]
        ? (a++,
          (s > 0 && l > 0 && e[s - 1]) || ((n += i ? Be("M", l + r, 0.5 + c + r) : Be("m", o, 0)), (o = 0), (i = !1)),
...
Lo.render = (t, r, n) => {
  const o = Mi.getOptions(r),
    ...
    a = t.modules.data,
    s = i + o.margin * 2,
    l = o.color.light.a ? "<path " + Fr(o.color.light, "fill") + ' d="M0 0h' + s + "v" + s + 'H0z"/>' : "",
    c = "<path " + Fr(o.color.dark, "stroke") + ' d="' + Si(a, i, o.margin) + '"/>',
    d = 'viewBox="0 0 ' + s + " " + s + '"',
    h =
...
function Er(e, t, r, n, o) {
  ...
  if (!s && !Oi()) throw new Error("Callback required as last argument");
  if (s) {
    ...
    return (
      a === 1 ? ((r = t), (t = n = void 0)) : a === 2 && !t.getContext && ((n = r), (r = t), (t = void 0)),
      new Promise((l, c) => {
        try {
...
Gt.toString = Er.bind(null, (e, t, r) => Ri.render(e, r));
var Pi = Object.defineProperty,
  Zr = Object.getOwnPropertySymbols,
  Li = Object.prototype.hasOwnProperty,
  Ni = Object.prototype.propertyIsEnumerable,
  Vr = (e, t, r) => (t in e ? Pi(e, t, { enumerable: !0, configurable: !0, writable: !0, value: r }) : (e[t] = r)),
  De = (e, t) => {
    for (var r in t || (t = {})) Li.call(t, r) && Vr(e, r, t[r]);
    if (Zr) for (var r of Zr(t)) Ni.call(t, r) && Vr(e, r, t[r]);
    return e;
  };
function Bi() {
  var e;
...
const I = {
  ...
  Di = T`button{border-radius:var(--wcm-secondary-button-border-radius);height:28px;padding:0 10px;background-color:var(--wcm-accent-color)}button path{fill:var(--wcm-accent-fill-color)}button::after{border-radius:inherit;border:1px solid var(--wcm-color-overlay)}button:disabled::after{background-color:transparent}.wcm-icon-left svg{margin-right:5px}.wcm-icon-right svg{margin-left:5px}button:active::after{background-color:var(--wcm-color-overlay)}.wcm-ghost,.wcm-ghost:active::after,.wcm-outline{background-color:transparent}.wcm-ghost:active{opacity:.5}@media(hover:hover){button:hover::after{background-color:var(--wcm-color-overlay)}.wcm-ghost:hover::after{background-color:transparent}.wcm-ghost:hover{opacity:.5}}button:disabled{background-color:var(--wcm-color-bg-3);pointer-events:none}.wcm-ghost::after{border-color:transparent}.wcm-ghost path{fill:var(--wcm-color-fg-2)}.wcm-outline path{fill:var(--wcm-accent-color)}.wcm-outline:disabled{background-color:transparent;opacity:.5}`;
var Ui = Object.defineProperty,
  Wi = Object.getOwnPropertyDescriptor,
  wt = (e, t, r, n) => {
    for (var o = n > 1 ? void 0 : n ? Wi(t, r) : t, i = e.length - 1, a; i >= 0; i--)
...
(Lt.styles = [I.globalCss, Hi]),
  Ue([$({ type: Boolean })], Lt.prototype, "disabled", 2),
  Ue([$()], Lt.prototype, "variant", 2),
  (Lt = Ue([k("wcm-button-big")], Lt));
const Fi = T`:host{background-color:var(--wcm-color-bg-2);border-top:1px solid var(--wcm-color-bg-3)}div{padding:10px 20px;display:inherit;flex-direction:inherit;align-items:inherit;width:inherit;justify-content:inherit}`;
var Zi = (e, t, r, n) => {
...
(We.styles = [I.globalCss, Fi]), (We = Zi([k("wcm-info-footer")], We));
const M = {
  ...
  Vi = T`.wcm-toolbar-placeholder{top:0;bottom:0;left:0;right:0;width:100%;position:absolute;display:block;pointer-events:none;height:100px;border-radius:calc(var(--wcm-background-border-radius) * .9);background-color:var(--wcm-background-color);background-position:center;background-size:cover}.wcm-toolbar{height:38px;display:flex;position:relative;margin:5px 15px 5px 5px;justify-content:space-between;align-items:center}.wcm-toolbar img,.wcm-toolbar svg{height:28px;object-position:left center;object-fit:contain}#wcm-wc-logo path{fill:var(--wcm-accent-fill-color)}button{width:28px;height:28px;border-radius:var(--wcm-icon-button-border-radius);border:0;display:flex;justify-content:center;align-items:center;cursor:pointer;background-color:var(--wcm-color-bg-1);box-shadow:0 0 0 1px var(--wcm-color-overlay)}button:active{background-color:var(--wcm-color-bg-2)}button svg{display:block;object-position:center}button path{fill:var(--wcm-color-fg-1)}.wcm-toolbar div{display:flex}@media(hover:hover){button:hover{background-color:var(--wcm-color-bg-2)}}`;
var Ki = (e, t, r, n) => {
  for (var o = t, i = e.length - 1, a; i >= 0; i--) (a = e[i]) && (o = a(o) || o);
  return o;
};
let He = class extends A {
  render() {
    return m`<div class="wcm-toolbar-placeholder"></div><div class="wcm-toolbar">${M.WALLET_CONNECT_LOGO} <button @click="${ce.close}">${M.CROSS_ICON}</button></div>`;
  }
};
(He.styles = [I.globalCss, Vi]), (He = Ki([k("wcm-modal-backcard")], He));
const qi = T`main{padding:20px;padding-top:0;width:100%}`;
var Yi = (e, t, r, n) => {
  for (var o = t, i = e.length - 1, a; i >= 0; i--) (a = e[i]) && (o = a(o) || o);
  return o;
};
...
(je.styles = [I.globalCss, qi]), (je = Yi([k("wcm-modal-content")], je));
const Ji = T`footer{padding:10px;display:flex;flex-direction:column;align-items:inherit;justify-content:inherit;border-top:1px solid var(--wcm-color-bg-2)}`;
var Gi = (e, t, r, n) => {
  for (var o = t, i = e.length - 1, a; i >= 0; i--) (a = e[i]) && (o = a(o) || o);
  return o;
};
...
(ze.styles = [I.globalCss, Ji]), (ze = Gi([k("wcm-modal-footer")], ze));
const Qi = T`header{display:flex;justify-content:center;align-items:center;padding:20px;position:relative}.wcm-border{border-bottom:1px solid var(--wcm-color-bg-2);margin-bottom:20px}header button{padding:15px 20px}header button:active{opacity:.5}@media(hover:hover){header button:hover{opacity:.5}}.wcm-back-btn{position:absolute;left:0}.wcm-action-btn{position:absolute;right:0}path{fill:var(--wcm-accent-color)}`;
var Xi = Object.defineProperty,
  ta = Object.getOwnPropertyDescriptor,
  Nt = (e, t, r, n) => {
    for (var o = n > 1 ? void 0 : n ? ta(t, r) : t, i = e.length - 1, a; i >= 0; i--)
      (a = e[i]) && (o = (n ? a(t, r, o) : a(o)) || o);
...
let ct = class extends A {
  ...
  backBtnTemplate() {
    return m`<button class="wcm-back-btn" @click="${N.goBack}">${M.BACK_ICON}</button>`;
  }
  actionBtnTemplate() {
...
const x = {
  ...
  ea = T`.wcm-router{overflow:hidden;will-change:transform}.wcm-content{display:flex;flex-direction:column}`;
var ra = Object.defineProperty,
  oa = Object.getOwnPropertyDescriptor,
  Fe = (e, t, r, n) => {
    for (var o = n > 1 ? void 0 : n ? oa(t, r) : t, i = e.length - 1, a; i >= 0; i--)
      (a = e[i]) && (o = (n ? a(t, r, o) : a(o)) || o);
...
(Bt.styles = [I.globalCss, ea]),
  Fe([j()], Bt.prototype, "view", 2),
  Fe([j()], Bt.prototype, "prevView", 2),
  (Bt = Fe([k("wcm-modal-router")], Bt));
const na = T`div{height:36px;width:max-content;display:flex;justify-content:center;align-items:center;padding:9px 15px 11px;position:absolute;top:12px;box-shadow:0 6px 14px -6px rgba(10,16,31,.3),0 10px 32px -4px rgba(10,16,31,.15);z-index:2;left:50%;transform:translateX(-50%);pointer-events:none;backdrop-filter:blur(20px) saturate(1.8);-webkit-backdrop-filter:blur(20px) saturate(1.8);border-radius:var(--wcm-notification-border-radius);border:1px solid var(--wcm-color-overlay);background-color:var(--wcm-color-overlay)}svg{margin-right:5px}@-moz-document url-prefix(){div{background-color:var(--wcm-color-bg-3)}}.wcm-success path{fill:var(--wcm-accent-color)}.wcm-error path{fill:var(--wcm-error-color)}`;
var ia = Object.defineProperty,
  aa = Object.getOwnPropertyDescriptor,
  qr = (e, t, r, n) => {
    for (var o = n > 1 ? void 0 : n ? aa(t, r) : t, i = e.length - 1, a; i >= 0; i--)
      (a = e[i]) && (o = (n ? a(t, r, o) : a(o)) || o);
...
let re = class extends A {
  ...
  render() {
    ...
    return this.open
      ? m`<div class="${G(r)}">${t === "success" ? M.CHECKMARK_ICON : null} ${t === "error" ? M.CROSS_ICON : null}<wcm-text variant="small-regular">${e}</wcm-text></div>`
      : null;
  }
};
(re.styles = [I.globalCss, na]), qr([j()], re.prototype, "open", 2), (re = qr([k("wcm-modal-toast")], re));
const sa = 0.1,
  Yr = 2.5,
  J = 7;
function Ze(e, t, r) {
  return e === t ? !1 : (e - t < 0 ? t - e : e - t) <= r + sa;
}
function la(e, t) {
...
const ca = {
    generate(e, t, r) {
      ...
      l.forEach(({ x: p, y: g }) => {
        const _ = (a.length - J) * s * p,
          u = (a.length - J) * s * g,
          y = 0.45;
        for (let w = 0; w < l.length; w += 1) {
          const v = s * (J - w * 2);
          i.push(
            L`<rect fill="${w % 2 === 0 ? n : o}" height="${v}" rx="${v * y}" ry="${v * y}" width="${v}" x="${_ + s * w}" y="${u + s * w}">`,
          );
        }
      });
      ...
      a.forEach((p, g) => {
        p.forEach((_, u) => {
          if (
            a[g][u] &&
            !((g < J && u < J) || (g > a.length - (J + 1) && u < J) || (g < J && u > a.length - (J + 1))) &&
            !(g > d && g < b && u > d && u < b)
          ) {
            const y = g * s + s / 2,
              w = u * s + s / 2;
      ...
      return (
        ...
        Object.entries(f)
          .map(([p, g]) => {
            const _ = g.filter((u) => g.every((y) => !Ze(u, y, s)));
            return [Number(p), _];
          })
          .forEach(([p, g]) => {
            g.forEach((_) => {
              i.push(L`<circle cx="${p}" cy="${_}" fill="${n}" r="${s / Yr}">`);
            });
          }),
        Object.entries(f)
          .filter(([p, g]) => g.length > 1)
          .map(([p, g]) => {
            const _ = g.filter((u) => g.some((y) => Ze(u, y, s)));
            return [Number(p), _];
          })
          .map(([p, g]) => {
            g.sort((u, y) => (u < y ? -1 : 1));
            const _ = [];
            for (const u of g) {
              const y = _.find((w) => w.some((v) => Ze(u, v, s)));
              y ? y.push(u) : _.push([u]);
            }
          ...
          .forEach(([p, g]) => {
            g.forEach(([_, u]) => {
              i.push(
                L`<line x1="${p}" x2="${p}" y1="${_}" y2="${u}" stroke="${n}" stroke-width="${s / (Yr / 2)}" stroke-linecap="round">`,
              );
            });
          }),
        i
...
let X = class extends A {
  ...
  svgTemplate() {
    ...
    return L`<svg height="${e}" width="${e}">${ca.generate(this.uri, e, e / 4)}</svg>`;
  }
  render() {
    const e = { "wcm-dark": _t.state.themeMode === "dark" };
    return m`<div style="${`width: ${this.size}px`}" class="${G(e)}">${this.walletId || this.imageUrl ? m`<wcm-wallet-image walletId="${W(this.walletId)}" imageId="${W(this.imageId)}" imageUrl="${W(this.imageUrl)}"></wcm-wallet-image>` : M.WALLET_CONNECT_ICON_COLORED} ${this.svgTemplate()}</div>`;
  }
};
(X.styles = [I.globalCss, da]),
...
let oe = class extends A {
  ...
  render() {
    return m`<input type="text" @input="${this.onChange}" placeholder="Search wallets"> ${M.SEARCH_ICON}`;
  }
};
(oe.styles = [I.globalCss, ma]), Jr([$()], oe.prototype, "onChange", 2), (oe = Jr([k("wcm-search-input")], oe));
const pa = T`@keyframes rotate{100%{transform:rotate(360deg)}}@keyframes dash{0%{stroke-dasharray:1,150;stroke-dashoffset:0}50%{stroke-dasharray:90,150;stroke-dashoffset:-35}100%{stroke-dasharray:90,150;stroke-dashoffset:-124}}svg{animation:rotate 2s linear infinite;display:flex;justify-content:center;align-items:center}svg circle{stroke-linecap:round;animation:dash 1.5s ease infinite;stroke:var(--wcm-accent-color)}`;
var wa = (e, t, r, n) => {
  for (var o = t, i = e.length - 1, a; i >= 0; i--) (a = e[i]) && (o = a(o) || o);
  return o;
};
...
let V = class extends A {
  ...
  render() {
    var e;
    return m`<button @click="${this.handleClick.bind(this)}"><div><wcm-wallet-image walletId="${this.walletId}" imageId="${W(this.imageId)}"></wcm-wallet-image><wcm-text variant="xsmall-regular">${(e = this.label) != null ? e : x.getWalletName(this.name, !0)}</wcm-text>${this.sublabelTemplate()}</div></button>`;
  }
};
(V.styles = [I.globalCss, xa]),
...
var Aa = Object.defineProperty,
  ...
  ne = (e, t, r, n) => {
    for (var o = n > 1 ? void 0 : n ? _a(t, r) : t, i = e.length - 1, a; i >= 0; i--)
      (a = e[i]) && (o = (n ? a(t, r, o) : a(o)) || o);
...
let bt = class extends A {
  ...
  render() {
    ...
    return m`${t.length ? m`<div><img crossorigin="anonymous" src="${t}" alt="${this.id}"></div>` : M.WALLET_PLACEHOLDER}`;
  }
};
(bt.styles = [I.globalCss, Ea]),
...
let qe = class extends A {
  ...
  async preloadListings() {
    if (gt.state.enableExplorer) {
      ...
      const { recomendedWallets: e } = H.state,
...
Gr([j()], qe.prototype, "preload", 2), (qe = Gr([k("wcm-explorer-context")], qe));
var Ta = (e, t, r, n) => {
  for (var o = t, i = e.length - 1, a; i >= 0; i--) (a = e[i]) && (o = a(o) || o);
  return o;
};
let Qr = class extends A {
  constructor() {
    super(), (this.unsubscribeTheme = void 0), I.setTheme(), (this.unsubscribeTheme = _t.subscribe(I.setTheme));
  }
  disconnectedCallback() {
    var e;
...
let Ye = class extends A {
  ...
  render() {
    ...
    return m`<wcm-modal-header title="Connect your wallet" .onAction="${this.onGoToQrcode}" .actionIcon="${M.QRCODE_ICON}"></wcm-modal-header><wcm-modal-content><div class="wcm-title">${M.MOBILE_ICON}<wcm-text variant="small-regular" color="accent">WalletConnect</wcm-text></div><div class="wcm-slider"><div class="wcm-track">${[
      ...Array(r),
    ].map((n, o) => {
      const i = t[o % t.length];
      return i
        ? m`<wcm-wallet-image walletId="${i.id}" imageId="${i.image_id}"></wcm-wallet-image>`
        : M.WALLET_PLACEHOLDER;
...
(Ye.styles = [I.globalCss, Ma]), (Ye = Sa([k("wcm-android-wallet-selection")], Ye));
const Oa = T`@keyframes loading{to{stroke-dashoffset:0}}@keyframes shake{10%,90%{transform:translate3d(-1px,0,0)}20%,80%{transform:translate3d(1px,0,0)}30%,50%,70%{transform:translate3d(-2px,0,0)}40%,60%{transform:translate3d(2px,0,0)}}:host{display:flex;flex-direction:column;align-items:center}div{position:relative;width:110px;height:110px;display:flex;justify-content:center;align-items:center;margin:40px 0 20px 0;transform:translate3d(0,0,0)}svg{position:absolute;width:110px;height:110px;fill:none;stroke:transparent;stroke-linecap:round;stroke-width:2px;top:0;left:0}use{stroke:var(--wcm-accent-color);animation:loading 1s linear infinite}wcm-wallet-image{border-radius:var(--wcm-wallet-icon-large-border-radius);width:90px;height:90px}wcm-text{margin-bottom:40px}.wcm-error svg{stroke:var(--wcm-error-color)}.wcm-error use{display:none}.wcm-error{animation:shake .4s cubic-bezier(.36,.07,.19,.97) both}.wcm-stale svg,.wcm-stale use{display:none}`;
var Ra = Object.defineProperty,
...
let et = class extends A {
  ...
  svgLoaderTemplate() {
    ...
    let n = 0;
    r.includes("%") ? (n = (88 / 100) * Number.parseInt(r, 10)) : (n = Number.parseInt(r, 10)), (n *= 1.17);
    const o = 317 - n * 1.57,
      i = 425 - n * 1.8;
...
const At = {
    manualWallets() {
      ...
      return (t = C.isMobile()
        ? a == null
          ? void 0
          : a.map(({ id: s, name: l, links: c }) => ({ id: s, name: l, mobile: c, links: c }))
        : a == null
          ? void 0
          : a.map(({ id: s, name: l, links: c }) => ({ id: s, name: l, desktop: c, links: c }))) != null
        ? t
        : [];
    },
    recentWallet() {
...
let Je = class extends A {
  render() {
    ...
    a ? (s = i.slice(0, 3)) : (s = i);
    const l = !!s.length;
    return m`<wcm-modal-header .border="${!0}" title="Connect your wallet" .onAction="${x.handleUriCopy}" .actionIcon="${M.COPY_ICON}"></wcm-modal-header><wcm-modal-content><div class="wcm-mobile-title"><div class="wcm-subtitle">${M.MOBILE_ICON}<wcm-text variant="small-regular" color="accent">Mobile</wcm-text></div><div class="wcm-subtitle">${M.SCAN_ICON}<wcm-text variant="small-regular" color="secondary">Scan with your wallet</wcm-text></div></div><wcm-walletconnect-qr></wcm-walletconnect-qr></wcm-modal-content>${l ? m`<wcm-modal-footer><div class="wcm-desktop-title">${M.DESKTOP_ICON}<wcm-text variant="small-regular" color="accent">Desktop</wcm-text></div><div class="wcm-grid">${s} ${a ? m`<wcm-view-all-wallets-button></wcm-view-all-wallets-button>` : null}</div></wcm-modal-footer>` : null}`;
  }
};
(Je.styles = [I.globalCss, La]), (Je = Na([k("wcm-desktop-wallet-selection")], Je));
const Ba = T`div{background-color:var(--wcm-color-bg-2);padding:10px 20px 15px 20px;border-top:1px solid var(--wcm-color-bg-3);text-align:center}a{color:var(--wcm-accent-color);text-decoration:none;transition:opacity .2s ease-in-out;display:inline}a:active{opacity:.8}@media(hover:hover){a:hover{opacity:.8}}`;
var Da = (e, t, r, n) => {
  for (var o = t, i = e.length - 1, a; i >= 0; i--) (a = e[i]) && (o = a(o) || o);
  return o;
};
...
(Ge.styles = [I.globalCss, Ba]), (Ge = Da([k("wcm-legal-notice")], Ge));
const Ua = T`div{display:grid;grid-template-columns:repeat(4,80px);margin:0 -10px;justify-content:space-between;row-gap:10px}`;
var Wa = (e, t, r, n) => {
  for (var o = t, i = e.length - 1, a; i >= 0; i--) (a = e[i]) && (o = a(o) || o);
  return o;
};
let Qe = class extends A {
  ...
  render() {
    ...
    a ? (s = i.slice(0, 7)) : (s = i);
    const l = !!s.length;
    return m`<wcm-modal-header title="Connect your wallet" .onAction="${this.onQrcode}" .actionIcon="${M.QRCODE_ICON}"></wcm-modal-header>${l ? m`<wcm-modal-content><div>${s} ${a ? m`<wcm-view-all-wallets-button></wcm-view-all-wallets-button>` : null}</div></wcm-modal-content>` : null}`;
  }
};
(Qe.styles = [I.globalCss, Ua]), (Qe = Wa([k("wcm-mobile-wallet-selection")], Qe));
...
var ja = Object.defineProperty,
  ...
  Xe = (e, t, r, n) => {
    for (var o = n > 1 ? void 0 : n ? za(t, r) : t, i = e.length - 1, a; i >= 0; i--)
      (a = e[i]) && (o = (n ? a(t, r, o) : a(o)) || o);
...
(Ut.styles = [I.globalCss, Ha]),
  Xe([j()], Ut.prototype, "open", 2),
  Xe([j()], Ut.prototype, "active", 2),
  (Ut = Xe([k("wcm-modal")], Ut));
const Fa = T`div{display:flex;margin-top:15px}slot{display:inline-block;margin:0 5px}wcm-button{margin:0 5px}`;
var Za = Object.defineProperty,
  Va = Object.getOwnPropertyDescriptor,
  Wt = (e, t, r, n) => {
    for (var o = n > 1 ? void 0 : n ? Va(t, r) : t, i = e.length - 1, a; i >= 0; i--)
      (a = e[i]) && (o = (n ? a(t, r, o) : a(o)) || o);
...
(dt.styles = [I.globalCss, Fa]),
  ...
  (dt = Wt([k("wcm-platform-selection")], dt));
const Ka = T`button{display:flex;flex-direction:column;padding:5px 10px;border-radius:var(--wcm-button-hover-highlight-border-radius);height:100%;justify-content:flex-start}.wcm-icons{width:60px;height:60px;display:flex;flex-wrap:wrap;padding:7px;border-radius:var(--wcm-wallet-icon-border-radius);justify-content:space-between;align-items:center;margin-bottom:5px;background-color:var(--wcm-color-bg-2);box-shadow:inset 0 0 0 1px var(--wcm-color-overlay)}button:active{background-color:var(--wcm-color-overlay)}@media(hover:hover){button:hover{background-color:var(--wcm-color-overlay)}}.wcm-icons img{width:21px;height:21px;object-fit:cover;object-position:center;border-radius:calc(var(--wcm-wallet-icon-border-radius)/ 2);border:1px solid var(--wcm-color-overlay)}.wcm-icons svg{width:21px;height:21px}.wcm-icons img:nth-child(1),.wcm-icons img:nth-child(2),.wcm-icons svg:nth-child(1),.wcm-icons svg:nth-child(2){margin-bottom:4px}wcm-text{width:100%;text-align:center}#wallet-placeholder-fill{fill:var(--wcm-color-bg-3)}#wallet-placeholder-dash{stroke:var(--wcm-color-overlay)}`;
var qa = (e, t, r, n) => {
  for (var o = t, i = e.length - 1, a; i >= 0; i--) (a = e[i]) && (o = a(o) || o);
  return o;
};
let tr = class extends A {
  ...
  render() {
    ...
    return m`<button @click="${this.onClick}"><div class="wcm-icons">${r.map((n) => {
      ...
      return i ? m`<img crossorigin="anonymous" src="${i}">` : M.WALLET_PLACEHOLDER;
    })} ${[...Array(4 - r.length)].map(() => M.WALLET_PLACEHOLDER)}</div><wcm-text variant="xsmall-regular">View All</wcm-text></button>`;
  }
};
(tr.styles = [I.globalCss, Ka]), (tr = qa([k("wcm-view-all-wallets-button")], tr));
const Ya = T`.wcm-qr-container{width:100%;display:flex;justify-content:center;align-items:center;aspect-ratio:1/1}`;
var Ja = Object.defineProperty,
  Ga = Object.getOwnPropertyDescriptor,
  ie = (e, t, r, n) => {
    for (var o = n > 1 ? void 0 : n ? Ga(t, r) : t, i = e.length - 1, a; i >= 0; i--)
      (a = e[i]) && (o = (n ? a(t, r, o) : a(o)) || o);
    return n && o && Ja(t, r, o), o;
  };
...
(er.styles = [I.globalCss]), (er = Qa([k("wcm-connect-wallet-view")], er));
const Xa = T`wcm-info-footer{flex-direction:column;align-items:center;display:flex;width:100%;padding:5px 0}wcm-text{text-align:center}`;
var ts = Object.defineProperty,
  es = Object.getOwnPropertyDescriptor,
  Xr = (e, t, r, n) => {
    for (var o = n > 1 ? void 0 : n ? es(t, r) : t, i = e.length - 1, a; i >= 0; i--)
      (a = e[i]) && (o = (n ? a(t, r, o) : a(o)) || o);
...
(ae.styles = [I.globalCss, Xa]),
  Xr([j()], ae.prototype, "isError", 2),
  (ae = Xr([k("wcm-desktop-connecting-view")], ae));
const rs = T`wcm-info-footer{flex-direction:column;align-items:center;display:flex;width:100%;padding:5px 0}wcm-text{text-align:center}wcm-button{margin-top:15px}`;
var os = (e, t, r, n) => {
  for (var o = t, i = e.length - 1, a; i >= 0; i--) (a = e[i]) && (o = a(o) || o);
  return o;
};
...
let se = class extends A {
  ...
  render() {
    ...
    return m`<wcm-modal-header title="${e}"></wcm-modal-header><wcm-modal-content><wcm-connector-waiting walletId="${t}" imageId="${W(r)}" label="Tap 'Open' to continue…" .isError="${this.isError}"></wcm-connector-waiting></wcm-modal-content><wcm-info-footer class="wcm-note"><wcm-platform-selection .isWeb="${i}" .isRetry="${!0}"><wcm-button .onClick="${() => this.openMobileApp(!1)}" .iconRight="${M.RETRY_ICON}">Retry</wcm-button></wcm-platform-selection>${s ? m`<wcm-text color="secondary" variant="small-thin">Still doesn't work? <span tabindex="0" @click="${() => this.openMobileApp(!0)}">Try this alternate link</span></wcm-text>` : null}</wcm-info-footer><wcm-info-footer class="wcm-app-store"><div><wcm-wallet-image walletId="${t}" imageId="${W(r)}"></wcm-wallet-image><wcm-text>${`Get ${e}`}</wcm-text></div><wcm-button .iconRight="${M.ARROW_RIGHT_ICON}" .onClick="${() => this.onGoToAppStore(a)}" variant="ghost">App Store</wcm-button></wcm-info-footer>`;
  }
};
(se.styles = [I.globalCss, ns]),
  to([j()], se.prototype, "isError", 2),
  (se = to([k("wcm-mobile-connecting-view")], se));
const ss = T`wcm-info-footer{flex-direction:column;align-items:center;display:flex;width:100%;padding:5px 0}wcm-text{text-align:center}`;
var ls = (e, t, r, n) => {
  for (var o = t, i = e.length - 1, a; i >= 0; i--) (a = e[i]) && (o = a(o) || o);
  return o;
};
...
(or.styles = [I.globalCss, ss]), (or = ls([k("wcm-mobile-qr-connecting-view")], or));
var cs = (e, t, r, n) => {
  for (var o = t, i = e.length - 1, a; i >= 0; i--) (a = e[i]) && (o = a(o) || o);
  return o;
};
let nr = class extends A {
  render() {
    return m`<wcm-modal-header title="Scan the code" .onAction="${x.handleUriCopy}" .actionIcon="${M.COPY_ICON}"></wcm-modal-header><wcm-modal-content><wcm-walletconnect-qr></wcm-walletconnect-qr></wcm-modal-content>`;
  }
};
(nr.styles = [I.globalCss]), (nr = cs([k("wcm-qrcode-view")], nr));
const ds = T`wcm-modal-content{height:clamp(200px,60vh,600px);display:block;overflow:scroll;scrollbar-width:none;position:relative;margin-top:1px}.wcm-grid{display:grid;grid-template-columns:repeat(4,80px);justify-content:space-between;margin:-15px -10px;padding-top:20px}wcm-modal-content::after,wcm-modal-content::before{content:'';position:fixed;pointer-events:none;z-index:1;width:100%;height:20px;opacity:1}wcm-modal-content::before{box-shadow:0 -1px 0 0 var(--wcm-color-bg-1);background:linear-gradient(var(--wcm-color-bg-1),rgba(255,255,255,0))}wcm-modal-content::after{box-shadow:0 1px 0 0 var(--wcm-color-bg-1);background:linear-gradient(rgba(255,255,255,0),var(--wcm-color-bg-1));top:calc(100% - 20px)}wcm-modal-content::-webkit-scrollbar{display:none}.wcm-placeholder-block{display:flex;justify-content:center;align-items:center;height:100px;overflow:hidden}.wcm-empty,.wcm-loading{display:flex}.wcm-loading .wcm-placeholder-block{height:100%}.wcm-end-reached .wcm-placeholder-block{height:0;opacity:0}.wcm-empty .wcm-placeholder-block{opacity:1;height:100%}wcm-wallet-button{margin:calc((100% - 60px)/ 3) 0}`;
var hs = Object.defineProperty,
  us = Object.getOwnPropertyDescriptor,
  Ht = (e, t, r, n) => {
    for (var o = n > 1 ? void 0 : n ? us(t, r) : t, i = e.length - 1, a; i >= 0; i--)
      (a = e[i]) && (o = (n ? a(t, r, o) : a(o)) || o);
...
let ht = class extends A {
  constructor() {
    super(...arguments),
      (this.loading = !H.state.wallets.listings.length),
      (this.firstFetch = !H.state.wallets.listings.length),
      (this.search = ""),
      (this.endReached = !1),
      (this.intersectionObserver = void 0),
      (this.searchDebounce = x.debounce((e) => {
        e.length >= 1
          ? ((this.firstFetch = !0), (this.endReached = !1), (this.search = e), H.resetSearch(), this.fetchWallets())
          : this.search && ((this.search = ""), (this.endReached = this.isLastPage()), H.resetSearch());
      }));
  }
  firstUpdated() {
  ...
  isLastPage() {
    const { wallets: e, search: t } = H.state,
      { listings: r, total: n } = this.search ? t : e;
    return n <= ir || r.length >= n;
  }
  async fetchWallets() {
    var e;
    const { wallets: t, search: r } = H.state,
  ...
  render() {
    ...
    const s = !this.loading && !r.length && !a.length,
      l = { "wcm-loading": n, "wcm-end-reached": this.endReached || !this.loading, "wcm-empty": s };
    return m`<wcm-modal-header><wcm-search-input .onChange="${this.onSearchChange.bind(this)}"></wcm-search-input></wcm-modal-header><wcm-modal-content class="${G(l)}"><div class="wcm-grid">${n ? null : i} ${n ? null : a} ${n ? null : r.map((c) => m`${c ? m`<wcm-wallet-button imageId="${c.image_id}" name="${c.name}" walletId="${c.id}" .onClick="${() => this.onConnect(c)}"></wcm-wallet-button>` : null}`)}</div><div class="wcm-placeholder-block">${s ? m`<wcm-text variant="big-bold" color="secondary">No results found</wcm-text>` : null} ${!s && this.loading ? m`<wcm-spinner></wcm-spinner>` : null}</div></wcm-modal-content>`;
  }
};
(ht.styles = [I.globalCss, ds]),
  Ht([j()], ht.prototype, "loading", 2),
  Ht([j()], ht.prototype, "firstFetch", 2),
  Ht([j()], ht.prototype, "search", 2),
  Ht([j()], ht.prototype, "endReached", 2),
  (ht = Ht([k("wcm-wallet-explorer-view")], ht));
const ms = T`wcm-info-footer{flex-direction:column;align-items:center;display:flex;width:100%;padding:5px 0}wcm-text{text-align:center}`;
var gs = Object.defineProperty,
  fs = Object.getOwnPropertyDescriptor,
  eo = (e, t, r, n) => {
    for (var o = n > 1 ? void 0 : n ? fs(t, r) : t, i = e.length - 1, a; i >= 0; i--)
      (a = e[i]) && (o = (n ? a(t, r, o) : a(o)) || o);
...
(le.styles = [I.globalCss, ms]), eo([j()], le.prototype, "isError", 2), (le = eo([k("wcm-web-connecting-view")], le));
