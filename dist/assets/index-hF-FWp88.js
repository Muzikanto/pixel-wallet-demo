const __vite__mapDeps = (
  i,
  m = __vite__mapDeps,
  d = m.f || (m.f = ["assets/index-B3Md8Pvu.js", "assets/index-BELpSH6A.js", "assets/index-CdxNHAo1.css"]),
) => i.map((i) => d[i]);
import { _ as fe } from "./index-BELpSH6A.js";
const me = Symbol(),
  ...
  z = {
    ...
    PROD: !0,
    SSR: !1,
    VITE_WC_PROJECT_ID: "b2634aede1fbadbea881afa7c2e7333d",
  },
  ...
  be = (
    ...
    c = (n, h, I = r) => {
      ...
      return (
        ...
        Reflect.ownKeys(n).forEach((P) => {
          ...
          const O = Reflect.get(n, P),
            M = { value: O, enumerable: !0, configurable: !0 };
          if (x.has(O)) te(O, !1);
          else if (O instanceof Promise) delete M.value, (M.get = () => I(O));
          else if (A.has(O)) {
            const [b, H] = A.get(O);
            M.value = c(b, H(), I);
          }
    ...
    W = (n) => {
      ...
      const O = (i = ++f[1]) => (
        ...
        b = new Map(),
        H = (i, a) => {
          if ((z ? "production" : void 0) !== "production" && b.has(i)) throw new Error("prop listener already exists");
          if (y.size) {
            const o = a[3](M(i));
            b.set(i, [a, o]);
          } else b.set(i, [a]);
        ...
        ue = (i) => (
          ...
          y.size === 1 &&
            b.forEach(([o, g], S) => {
              if ((z ? "production" : void 0) !== "production" && g) throw new Error("remove already exists");
              const T = o[3](M(S));
              b.set(S, [o, T]);
            }),
          () => {
        ...
        $ = t(J, {
          ...
          set(i, a, o, g) {
            const S = Reflect.has(i, a),
              T = Reflect.get(i, a, g);
            if (S && (e(T, o) || (m.has(o) && e(T, m.get(o))))) return !0;
            Z(a), q(o) && (o = he(o) || o);
            let V = o;
...
const d = j({ history: ["ConnectWallet"], view: "ConnectWallet", data: void 0 }),
  de = {
    state: d,
    subscribe(e) {
      return _(d, () => e(d));
  ...
  u = j({ enabled: we, userSessionId: "", events: [], connectedWalletId: void 0 }),
  Ie = {
    state: u,
    subscribe(e) {
      return _(u.events, () => e(ve(u.events[u.events.length - 1])));
    },
    initialize() {
      u.enabled &&
...
var Ee = Object.defineProperty,
  ...
  ne = (e, t, s) => (t in e ? Ee(e, t, { enumerable: !0, configurable: !0, writable: !0, value: s }) : (e[t] = s)),
  We = (e, t) => {
...
var Ce = Object.defineProperty,
  ...
  re = (e, t, s) => (t in e ? Ce(e, t, { enumerable: !0, configurable: !0, writable: !0, value: s }) : (e[t] = s)),
  Me = (e, t) => {
  ...
  Re = {
    ...
    async getRecomendedWallets() {
      ...
      if (p.isArray(e)) {
        ...
        const { chains: s, isAuth: r } = w.state,
          ...
          { listings: f } = ae ? await U.getMobileListings(m) : await U.getDesktopListings(m);
    ...
    async getWallets(e) {
      ...
      const { page: c, search: m } = e,
        { listings: f, total: W } = ae ? await U.getMobileListings(t) : await U.getDesktopListings(t),
        n = Object.values(f),
        h = m ? "search" : "wallets";
      return (L[h] = { listings: [...L[h].listings, ...n], total: W, page: c ?? 1 }), { listings: n, total: W };
    },
    getWalletImageUrl(e) {
...
var Ue = Object.defineProperty,
  ...
  le = (e, t, s) => (t in e ? Ue(e, t, { enumerable: !0, configurable: !0, writable: !0, value: s }) : (e[t] = s)),
  Pe = (e, t) => {
    for (var s in t || (t = {})) De.call(t, s) && le(e, s, t[s]);
    if (ie) for (var s of ie(t)) _e.call(t, s) && le(e, s, t[s]);
    return e;
  };
function Se() {
  return typeof matchMedia < "u" && matchMedia("(prefers-color-scheme: dark)").matches;
}
const R = j({ themeMode: Se() ? "dark" : "light" }),
  ce = {
    state: R,
    subscribe(e) {
      return _(R, () => e(R));
    ...
    setThemeConfig(e) {
      ...
      t && (R.themeMode = t), s && (R.themeVariables = Pe({}, s));
    },
  },
...
class ke {
  ...
  async initUi() {
    if (typeof window < "u") {
      await fe(() => import("./index-B3Md8Pvu.js"), __vite__mapDeps([0, 1, 2]));
...
const Ve = Object.freeze(
  Object.defineProperty({ __proto__: null, WalletConnectModal: ke }, Symbol.toStringTag, { value: "Module" }),
);
export { Ie as R, de as T, p as a, Ve as i, ce as n, $e as o, w as p, F as s, Re as t, N as y };
