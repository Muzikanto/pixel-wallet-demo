import { a as _t, b as an, c as on, j as rn, s as sn, r as vt } from "./hooks.module-TTwXDDkr.js";
import { c as M, g as nn } from "./index-BELpSH6A.js";
var Et = {},
  te = {},
  me = {};
...
((n) => {
  ...
  var e = U;
  Object.defineProperty(n, "standardErrorCodes", { enumerable: !0, get: () => e.standardErrorCodes });
  var t = ye;
  Object.defineProperty(n, "standardErrors", { enumerable: !0, get: () => t.standardErrors });
})(j);
var we = {},
  Q = {};
...
function mn(n) {
  return typeof n == "string"
    ...
    : (0, un.isErrorResponse)(n)
      ? Object.assign(Object.assign({}, n), { message: n.errorMessage, code: n.errorCode, data: { method: n.method } })
      : n;
}
function bn(n, e) {
...
function xn() {
  ...
  return !r || r.startsWith("javascript:") || r.startsWith("vbscript:")
    ? null
    : r.startsWith("http://") || r.startsWith("https://") || r.startsWith("data:")
      ? r
      : r.startsWith("//")
        ? e + r
        : `${e}//${t}${r}`;
...
async function Tn(n, e) {
  return crypto.subtle.deriveKey({ name: "ECDH", public: e }, n, { name: "AES-GCM", length: 256 }, !1, [
    "encrypt",
    "decrypt",
  ]);
}
...
async function jt(n, e) {
  const t = crypto.getRandomValues(new Uint8Array(12)),
    r = await crypto.subtle.encrypt({ name: "AES-GCM", iv: t }, n, new TextEncoder().encode(e));
...
class Bn {
  ...
  async loadKeysIfNeeded() {
    if (
      ...
      this.ownPublicKey === null && (this.ownPublicKey = await this.loadKey(We)),
...
class Kn {
  ...
  constructor(e) {
    ...
    s && this.updateListener.onAccountsUpdate({ accounts: s, source: "storage" }),
...
class Fn {
  ...
  async handshake() {
    const e = await this.createRequestMessage({ handshake: { method: "eth_requestAccounts", params: this.metadata } }),
  ...
  async sendEncryptedRequest(e) {
    ...
    const r = await (0, de.encryptContent)({ action: e, chainId: this.stateManager.activeChain.id }, t),
...
function Ut(n, e) {
  let t = n.toString(16);
  t.length % 2 !== 0 && (t = "0" + t);
  const r = t.match(/.{1,2}/g).map((s) => Number.parseInt(s, 16));
  while (r.length < e) r.unshift(0);
...
function Bt(n, e, t) {
  ...
  return (
    (n = ke(n)),
    t ? (n.length < e ? (n.copy(r), r) : n.slice(0, e)) : n.length < e ? (n.copy(r, e - n.length), r) : n.slice(-e)
  );
}
function Gn(n, e) {
  return Bt(n, e, !0);
...
function G(n) {
  return Number.parseInt(/^\D+(\d+)$/.exec(n)[1], 10);
}
function rt(n) {
...
const A = qt,
  ...
  Be = {
    ...
    findTypeDependencies(n, e, t = []) {
      ...
      t.push(n);
      for (const r of e[n]) for (const s of this.findTypeDependencies(r.type, e, t)) !t.includes(s) && t.push(s);
      return t;
    },
    ...
    hash(n, e = !0) {
      ...
      return (
        ...
        t.primaryType !== "EIP712Domain" && r.push(this.hashStruct(t.primaryType, t.message, t.types, e)),
...
var sr = {
  ...
  TypedDataUtils: Be,
  hashForSignTypedDataLegacy: (n) => ir(n.data),
  hashForSignTypedData_v3: (n) => Be.hash(n.data, !1),
  hashForSignTypedData_v4: (n) => Be.hash(n.data),
};
function ir(n) {
  const e = new Error("Expect argument to be non-empty array");
  if (typeof n != "object" || !n.length) throw e;
  const t = n.map((i) => (i.type === "bytes" ? A.toBuffer(i.value) : i.value)),
    r = n.map((i) => i.type),
    s = n.map((i) => {
      if (!i.name) throw e;
  ...
  return ee.soliditySHA3(
    ["bytes32", "bytes32"],
    [ee.soliditySHA3(new Array(n.length).fill("string"), s), ee.soliditySHA3(r, t)],
  );
}
var N = {};
Object.defineProperty(N, "__esModule", { value: !0 });
...
class cr {
  ...
  async encrypt(e) {
    ...
    const r = crypto.getRandomValues(new Uint8Array(12)),
      s = await crypto.subtle.importKey("raw", (0, le.hexStringToUint8Array)(t), { name: "aes-gcm" }, !1, [
        "encrypt",
        "decrypt",
      ]),
      i = new TextEncoder(),
      a = await window.crypto.subtle.encrypt({ name: "AES-GCM", iv: r }, s, i.encode(e)),
      o = 16,
  ...
  async decrypt(e) {
    ...
    return new Promise((r, s) => {
      (async () => {
        const i = await crypto.subtle.importKey("raw", (0, le.hexStringToUint8Array)(t), { name: "aes-gcm" }, !1, [
            "encrypt",
            "decrypt",
          ]),
...
class dr {
  ...
  async markUnseenEventsAsSeen(e) {
    return Promise.all(
      e.map((t) =>
        fetch(`${this.linkAPIUrl}/events/${t.eventId}/seen`, { method: "POST", headers: { Authorization: this.auth } }),
      ),
    ).catch((t) => console.error("Unabled to mark event as failed:", t));
  }
  async fetchUnseenEvents() {
    var e;
    const t = await fetch(`${this.linkAPIUrl}/events?unseen=true`, { headers: { Authorization: this.auth } });
    if (t.ok) {
...
class lr {
  ...
  async connect() {
    ...
    return new Promise((e, t) => {
      ...
      (r = this.connectionStateListener) === null || r === void 0 || r.call(this, Z.CONNECTING),
        (s.onclose = (i) => {
          var a;
          this.clearWebSocket(),
        ...
        (s.onmessage = (i) => {
          var a, o;
          if (i.data === "h")
            (a = this.incomingDataListener) === null || a === void 0 || a.call(this, { type: "Heartbeat" });
          else
            try {
...
class pr {
  ...
  sendIsLinked() {
    const e = { type: "IsLinked", id: (0, F.IntNumber)(this.nextReqId++), sessionId: this.session.id };
    this.sendData(e);
  }
  sendGetSessionConfig() {
    const e = { type: "GetSessionConfig", id: (0, F.IntNumber)(this.nextReqId++), sessionId: this.session.id };
    this.sendData(e);
  }
}
...
class Ve {
  constructor(e, t, r, s) {
    (this._storage = e),
      ...
      (this._key = new fr.sha256().update(`${this._id}, ${this._secret} WalletLink`).digest("hex")),
      (this._linked = !!s);
  }
  static load(e) {
...
function mr(n, e, t, r, s, i) {
  const a = r ? "parent-id" : "id",
    o = new URLSearchParams({ [a]: n, secret: e, server: t, v: s, chainId: i.toString() }).toString();
  return `${t}/#/link?${o}`;
}
S.createQrUrl = mr;
function br() {
...
var _r = (M && M.__importDefault) || ((n) => (n && n.__esModule ? n : { default: n }));
Object.defineProperty(ae, "__esModule", { value: !0 });
...
((n) => {
  var e = (M && M.__importDefault) || ((d) => (d && d.__esModule ? d : { default: d }));
  Object.defineProperty(n, "__esModule", { value: !0 }),
...
var Zt = (M && M.__importDefault) || ((n) => (n && n.__esModule ? n : { default: n }));
...
const Nr = ({ title: n, buttonText: e, darkMode: t, onButtonClick: r, onDismiss: s }) => {
...
class W {
    ...
    (this.accountsCallback = null),
      ...
      (this.chainUpdated = (i, a) => {
        (this.chainCallbackParams.chainId === i && this.chainCallbackParams.jsonRpcUrl === a) ||
          ((this.chainCallbackParams = { chainId: i, jsonRpcUrl: a }), this.chainCallback && this.chainCallback(i, a));
      }),
        ...
        this.accountsCallback && this.accountsCallback([i]),
          W.accountRequestCallbackIds.size > 0 &&
            (Array.from(W.accountRequestCallbackIds.values()).forEach((a) => {
              const o = { type: "WEB3_RESPONSE", id: a, response: { method: "requestEthereumAccounts", result: [i] } };
  ...
  subscribe() {
    const e = He.WalletLinkSession.load(this.storage) || new He.WalletLinkSession(this.storage).save(),
      { linkAPIUrl: t } = this,
      r = new Wr.WalletLinkConnection({ session: e, linkAPIUrl: t, listener: this }),
  ...
  resetAndReload() {
    Promise.race([
      ...
      .then(() => {
        ...
        (e == null ? void 0 : e.id) === this._session.id && $r.ScopedLocalStorage.clearAll(),
  ...
  signEthereumMessage(e, t, r, s) {
    return this.sendRequest({
      ...
      params: { message: (0, b.hexStringFromBuffer)(e, !0), address: t, addPrefix: r, typedDataJson: s || null },
    });
  }
  ...
  submitEthereumTransaction(e, t) {
    return this.sendRequest({
      ...
      params: { signedTransaction: (0, b.hexStringFromBuffer)(e, !0), chainId: t },
    });
  }
  scanQRCode(e) {
  ...
  genericRequest(e, t) {
    return this.sendRequest({ method: "generic", params: { action: t, data: e } });
  }
  ...
  handleWeb3ResponseMessage(e) {
    ...
    if (t.method === "requestEthereumAccounts") {
      W.accountRequestCallbackIds.forEach((r) => this.invokeCallback(Object.assign(Object.assign({}, e), { id: r }))),
        W.accountRequestCallbackIds.clear();
      return;
    }
  ...
  handleErrorResponse(e, t, r) {
    ...
    this.handleWeb3ResponseMessage({ type: "WEB3_RESPONSE", id: e, response: { method: t, errorMessage: i } });
  }
  invokeCallback(e) {
  ...
  watchAsset(e, t, r, s, i, a) {
    const o = {
      method: "watchAsset",
      params: { type: e, options: { address: t, symbol: r, decimals: s, image: i }, chainId: a },
    };
    let c = null;
  ...
  addEthereumChain(e, t, r, s, i, a) {
    const o = {
      ...
      params: { chainId: e, rpcUrls: t, blockExplorerUrls: s, chainName: i, iconUrls: r, nativeCurrency: a },
    };
    let c = null;
    const l = (0, b.randomBytesHex)(8),
      h = (f) => {
  ...
  switchEthereumChain(e, t) {
    const r = { method: "switchEthereumChain", params: Object.assign({ chainId: e }, { address: t }) },
...
var Fr = (M && M.__importDefault) || ((n) => (n && n.__esModule ? n : { default: n }));
...
class Gr {
  constructor(e) {
    ...
    (this._appName = s),
      (this._appLogoUrl = i),
      (this._storage = new Zr.ScopedLocalStorage("walletlink", ht.WALLETLINK_URL)),
      (this.updateListener = e.updateListener),
    ...
    this._storage.getItem(qe) &&
      ((r = this.updateListener) === null ||
        r === void 0 ||
        r.onChainUpdate({ chain: { id: this.getChainId(), rpcUrl: this.jsonRpcUrl }, source: "storage" }),
  ...
  updateProviderInfo(e, t) {
    ...
    this._storage.setItem(qe, t.toString(10)),
      ((0, g.ensureIntNumber)(t) !== s || !this.hasMadeFirstChainChangedEmission) &&
        ((r = this.updateListener) === null ||
          r === void 0 ||
  ...
  async addEthereumChain(e, t, r, s, i, a) {
    ...
    return (0, D.isErrorResponse)(h)
      ? !1
      : (((o = h.result) === null || o === void 0 ? void 0 : o.isApproved) === !0 && this.updateProviderInfo(t[0], e),
  ...
  async switchEthereumChain(e) {
    ...
    if ((0, D.isErrorResponse)(r)) {
      ...
      throw r.errorCode === w.standardErrorCodes.provider.unsupportedChain
        ...
        : w.standardErrors.provider.custom({ message: r.errorMessage, code: r.errorCode });
    }
    const s = r.result;
  ...
  async _request(e) {
    if (!e || typeof e != "object" || Array.isArray(e))
      throw w.standardErrors.rpc.invalidRequest({ message: "Expected a single, non-array, object argument.", data: e });
    const { method: t, params: r } = e;
    if (typeof t != "string" || t.length === 0)
      throw w.standardErrors.rpc.invalidRequest({ message: "'args.method' must be a non-empty string.", data: e });
    ...
    return (await this._sendRequestAsync({ method: t, params: s, jsonrpc: "2.0", id: i })).result;
  }
  _setAddresses(e, t) {
    var r;
    ...
    JSON.stringify(s) !== JSON.stringify(this._addresses) &&
      ((this._addresses = s),
      (r = this.updateListener) === null || r === void 0 || r.onAccountsUpdate({ accounts: s, source: "wallet" }),
  ...
  async _signEthereumMessage(e, t, r, s) {
    ...
    try {
      ...
      throw typeof i.message == "string" && i.message.match(/(denied|rejected)/i)
        ? w.standardErrors.provider.userRejectedRequest("User denied message signature")
        : i;
    }
  }
  ...
  async _eth_requestAccounts() {
    if (this._isAuthorized()) return Promise.resolve({ jsonrpc: "2.0", id: 0, result: this._addresses });
    let e;
    try {
      ...
      throw typeof t.message == "string" && t.message.match(/(denied|rejected)/i)
        ? w.standardErrors.provider.userRejectedRequest("User denied account authorization")
        : t;
    }
  ...
  async _eth_signTransaction(e) {
    ...
    try {
      ...
      throw typeof r.message == "string" && r.message.match(/(denied|rejected)/i)
        ? w.standardErrors.provider.userRejectedRequest("User denied transaction signature")
        : r;
    }
  }
  ...
  async _wallet_addEthereumChain(e) {
    ...
    const o = Number.parseInt(a.chainId, 16);
  ...
  async _wallet_switchEthereumChain(e) {
    const t = e[0];
    return await this.switchEthereumChain(Number.parseInt(t.chainId, 16)), { jsonrpc: "2.0", id: 0, result: null };
  }
  ...
  initializeRelay() {
    if (!this._relay) {
      const e = new zr.WalletLinkRelay({ linkAPIUrl: ht.WALLETLINK_URL, storage: this._storage });
      e.setAppInfo(this._appName, this._appLogoUrl),
        e.attachUI(),
        e.setAccountsCallback((t, r) => this._setAddresses(t, r)),
        e.setChainCallback((t, r) => {
          this.updateProviderInfo(r, Number.parseInt(t, 10));
        }),
        (this._relay = e);
    }
    return this._relay;
  ...
  return (
    await (
      await window.fetch(e.rpcUrl, {
        ...
        mode: "cors",
        headers: { "Content-Type": "application/json", "X-Cbw-Sdk-Version": Yr.LIB_VERSION },
      })
    ).json()
  ).result;
}
...
function ts(n) {
  if (!n || typeof n != "object" || Array.isArray(n))
    return pe.standardErrors.rpc.invalidParams({ message: "Expected a single, non-array, object argument.", data: n });
  const { method: e, params: t } = n;
  if (typeof e != "string" || e.length === 0)
    return pe.standardErrors.rpc.invalidParams({ message: "'args.method' must be a non-empty string.", data: n });
...
async function cs(n) {
  ...
  ls(e, t).catch(() => {});
  const r = { id: crypto.randomUUID(), event: "selectSignerType", data: n.preference },
...
function ds(n) {
  ...
  switch (e) {
    case "scw":
      return new ns.SCWSigner({ metadata: t, updateListener: s, communicator: r });
    case "walletlink":
...
async function ls(n, e) {
  ...
  n.postMessage({ event: "WalletLinkUpdate", data: { session: t.getSession() } }),
    await t.handshake(),
...
function hs(n) {
  ...
  if ((r == null || r.focus(), !r)) throw us.standardErrors.rpc.internal("Pop up window failed to open");
  return r;
}
J.openPopup = hs;
function gs(n) {
      ...
      (this.disconnect = () => {
        (0, mt.closePopup)(this.popup),
          ...
          this.listeners.forEach(({ reject: t }, r) => {
            t(bt.standardErrors.provider.userRejectedRequest("Request rejected")),
        ...
        this.popup && !this.popup.closed
          ...
          : ((this.popup = (0, mt.openPopup)(this.url)),
            ...
            this.onMessage(({ event: t }) => t === "PopupLoaded")
              .then((t) => {
                this.postMessage({ requestId: t.id, data: { version: ps.LIB_VERSION } });
              })
              .then(() => {
...
var ys =
  ...
  ws = (M && M.__importDefault) || ((n) => (n && n.__esModule ? n : { default: n }));
...
class ks extends vs.default {
      ...
      (this.handlers = {
        handshake: async (l) => {
          try {
            if (this.connected)
              return (
                this.emit("connect", { chainId: (0, X.hexStringFromIntNumber)((0, he.IntNumber)(this.chain.id)) }),
                this.accounts
              );
      ...
      (this.updateListener = {
        onAccountsUpdate: ({ accounts: l, source: h }) => {
          (0, X.areAddressArraysEqual)(this.accounts, l) ||
            ((this.accounts = l), h !== "storage" && this.emit("accountsChanged", this.accounts));
        },
        onChainUpdate: ({ chain: l, source: h }) => {
          (l.id === this.chain.id && l.rpcUrl === this.chain.rpcUrl) ||
            ((this.chain = l),
            h !== "storage" && this.emit("chainChanged", (0, X.hexStringFromIntNumber)((0, he.IntNumber)(l.id))));
        },
      }),
      (this.metadata = s),
      (this.preference = o),
  ...
  async request(e) {
    ...
    try {
      ...
      if (r) throw r;
      const s = (t = (0, Ss.determineMethodCategory)(e.method)) !== null && t !== void 0 ? t : "fetch";
...
class Ps {
  ...
  makeWeb3Provider(e = { options: "all" }) {
    ...
    return (t = (0, xs.getCoinbaseInjectedProvider)(r)) !== null && t !== void 0 ? t : new Ms.CoinbaseWalletProvider(r);
  }
...
((n) => {
  ...
  var t = te;
  Object.defineProperty(n, "CoinbaseWalletSDK", { enumerable: !0, get: () => t.CoinbaseWalletSDK });
})(Et);
const Ns = nn(Et),
  Os = Object.freeze(Object.defineProperty({ __proto__: null, default: Ns }, Symbol.toStringTag, { value: "Module" }));
export { Os as i };
